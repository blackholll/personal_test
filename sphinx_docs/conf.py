...
# default: ``['localtoc.html', 'relations.html', 'sourcelinks.html',
# 'searchbox.html']``.
#
# html_sidebars = {}
...
#  author, documentclass [howto, manual, or own own]).
latex_documents = [
    (master_doc, 'mydocs.tex', 'My Documentation',
     'Your Name', 'manual'),
]
...
man_pages = [
    (master_doc, 'mydocs', 'My Documentation',
     [author], 1)
]
...
# Locale directory for gettext translation
locale_dirs = ['locale/']
gettext_compact = False

# Languages supported
# These should match the languages configured in Read the Docs
